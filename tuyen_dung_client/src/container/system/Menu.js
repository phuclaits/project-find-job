  ...
  return (
    <nav className="sidebar sidebar-offcanvas" id="sidebar">
      <ul className="nav">
        ...
        {user && user.codeRoleAccount === "ADMIN" && (
          <>
            <li className="nav-item relative">
              <a
                className="nav-link"
          ...
          <>
            ...
            <li className="nav-item relative">
              <a
                ...
                aria-expanded="false"
                aria-controls="applicationList"
              >
                <i className="fas fa-list menu-icon"></i>
                <span className="menu-title">Danh sách ứng tuyển</span>
                <i className="menu-arrow" />
              </a>
              <div className="collapse" id="applicationList">
                <ul className="nav flex-column sub-menu">
                  <li className="nav-item relative">
                    <Link className="nav-link" to="/admin/application-list/new">
                      Ứng tuyển mới
                    </Link>
                  </li>
                  <li className="nav-item relative">
                    <Link
                      className="nav-link"
                      to="/admin/application-list/under-review"
                    >
                      Đang xem xét
                    </Link>
                  </li>
                  <li className="nav-item relative">
                    <Link
                      className="nav-link"
                      to="/admin/application-list/accepted"
                    >
                      Đã chấp nhận
                    </Link>
                  </li>
                  <li className="nav-item relative">
                    <Link
                      className="nav-link"
                      to="/admin/application-list/rejected"
                    >
                      Đã từ chối
                    </Link>
                  </li>
