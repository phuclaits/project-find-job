...
public class PostSearchQueryCriteriaConsumer implements Consumer<SearchCriteria> {
    private CriteriaBuilder builder;
    private Predicate predicate;
    private Root root;

    
    public PostSearchQueryCriteriaConsumer(CriteriaBuilder builder, Predicate predicate, Root root) {
